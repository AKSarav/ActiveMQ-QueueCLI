  ...
  public static void main(String[] args) throws IOException, JMSException, URISyntaxException
  {
      ...
      try {
          ...
          do {
              ...
              System.out.print ("\nEnter the Queue Name you wanna send this message to  (or) \"quit\" to exit : ");
              String QN;
              QN = msgStream.readLine();
              QN=QN.trim();
              
              
          if ( QN == "" || QN.equals(null) || QN.trim().length() == 0 )
          {
            LOGGER.error("Queue name is Invalid, Please Enter Valid QueueName");
            
          }
          else if( QN.equalsIgnoreCase("Quit"))
          {
              String ans;
              int choice;
